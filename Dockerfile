...
#   && npm install -g "cypress@10.6.0" \
  && npm install -g "https://cdn.cypress.io/beta/npm/10.7.0/linux-x64/tbiethman/23380-root-spec-pattern-e0d4af73c79f9e6dc80259ff3dd227657e93c7c2/cypress.tgz" \
...
ENTRYPOINT [ "cypress", "run", "--spec", "'cypress/**/*.cy.js'" ]